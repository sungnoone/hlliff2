...
document.addEventListener("preScannerModuleLoaded", async function() {
	mwbScanner.set_scannerConfig(scannerConfig);
	scannerConfig();
});
document.addEventListener("scannerModuleLoaded", async function(e) {
	...
	//mwbScanner.scanImage("test_img.png");
...
var scannerConfig = function(){
	...
	*/
	...
	mwbScanner.setIcon("wasm_license_23208.png");
	...
	settings = [
		...
		//,{"method" : "MWBenableClose", "value" : [false]}
		...
		,{"method" : "MWBsetDecoderTimeout", "value" : [60]} //10-60, 0 to disable
		,{"method" : "MWBsetDpsLimit", "value" : [2]} //1-30 default 2
