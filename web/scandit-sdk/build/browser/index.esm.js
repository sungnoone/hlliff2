...
$export$h($export$h.G + $export$h.W + $export$h.F * !USE_NATIVE, { Symbol: $Symbol });
...
$export$h($export$h.S + $export$h.F * !USE_NATIVE, 'Symbol', {
...
$export$h($export$h.S + $export$h.F * !USE_NATIVE, 'Object', {
...
$JSON$1 && $export$h($export$h.S + $export$h.F * (!USE_NATIVE || $fails(function () {
  var S = $Symbol();
...
var _objectSap = function (KEY, exec) {
  ...
  var exp = {};
  exp[KEY] = exec(fn);
  $export$e($export$e.S + $export$e.F * fails$3(function () { fn(1); }), 'Object', exp);
};
...
$export$d($export$d.S, 'Object', { setPrototypeOf: _setProto.set });
...
var _bind = Function.bind || function bind(that /* , ...args */) {
  ...
  if (isObject$4(fn.prototype)) bound.prototype = fn.prototype;
  return bound;
};
...
$export$c($export$c.S + $export$c.F * (NEW_TARGET_BUG || ARGS_BUG), 'Reflect', {
...
function _setPrototypeOf(o, p) {
  _setPrototypeOf = setPrototypeOf ? setPrototypeOf.bind() : function _setPrototypeOf(o, p) {
    o.__proto__ = p;
    return o;
  };
...
function _inherits(subClass, superClass) {
  ...
  defineProperty(subClass, "prototype", {
    writable: false
  });
...
function _getPrototypeOf(o) {
  _getPrototypeOf = setPrototypeOf ? getPrototypeOf.bind() : function _getPrototypeOf(o) {
...
function dataCapture() {
  ...
  function loadLibrary(deviceId, libraryLocation, locationPath, preload, newDelayedRegistration, newHighEndBlurryRecognition, textRecognition, newLicenseKey, deviceModelName) {
    ...
    Module = {
      ...
      instantiateWasm: function instantiateWasm(importObject, successCallback) {
        ...
        if (wasmJSVersion !== "5.12.1") {
          log("error", "The Scandit Data Capture library JS file found at ".concat(jsURI, " seems invalid: ") + "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "5.12.1", "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
        }
  ...
  function getLibraryLocationURIs(libraryLocation, textRecognition, simdSupport) {
    ...
    if (/^https?:\/\/([^\/.]*\.)*cdn.jsdelivr.net\//.test(libraryLocation)) {
      libraryLocation = "https://cdn.jsdelivr.net/npm/scandit-sdk@5.12.1/build/";
      cdnURI = true;
    } else if (/^https?:\/\/([^\/.]*\.)*unpkg.com\//.test(libraryLocation)) {
      libraryLocation = "https://unpkg.com/scandit-sdk@5.12.1/build/";
      cdnURI = true;
    }
    ...
    return {
      jsURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(fileExtension, ".min.js?v=5.12.1"),
      wasmURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(fileExtension, ".wasm?v=5.12.1")
    };
  }
    ...
    function verifyResponseData(responseData) {
      ...
      if (typeof ((_crypto = crypto) === null || _crypto === void 0 ? void 0 : (_crypto$subtle = _crypto.subtle) === null || _crypto$subtle === void 0 ? void 0 : _crypto$subtle.digest) === "function") {
        crypto.subtle.digest("SHA-256", responseData).then(function (hash) {
          ...
          let expectedHashString = "4572045fed6c242bd9523d4c4890c8832b1d8ded591f5f84a452f66b86affb5d";
...
var UnsupportedBrowserError = /*#__PURE__*/function (_CustomError) {
  ...
  return _createClass(UnsupportedBrowserError);
}(CustomError);
...
var Scanner = /*#__PURE__*/function () {
  ...
  _createClass(Scanner, [{
    ...
    value: function dataCaptureWorkerOnMessage(ev) {
      ...
      if (data[0] === "log") {
        data[1].data.forEach(function (dataArgument, index) {
...
function ownKeys$2(object, enumerableOnly) { var keys = Object.keys(object); if (getOwnPropertySymbols) { var symbols = getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
function ownKeys$1(object, enumerableOnly) { var keys = Object.keys(object); if (getOwnPropertySymbols) { var symbols = getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var CameraManager = /*#__PURE__*/function () {
  function CameraManager(scanner, triggerCameraAccessError, gui) {
    ...
    _defineProperty(this, "cameraAccessRejectCallback", void 0);
    ...
    _defineProperty(this, "abortedCameraInitializationResolveCallback", void 0);
  ...
  _createClass(CameraManager, [{
    ...
    value: function () {
      var _stopStream = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
        ...
        var cameraInitializationFailure,
            _args4 = arguments;
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                cameraInitializationFailure = _args4.length > 0 && _args4[0] !== undefined ? _args4[0] : false;
                ...
                Logger.log(Logger.Level.DEBUG, "Stop camera video stream access".concat(cameraInitializationFailure ? " (abort access detection)" : "", ":"), this.mediaStream);
                ...
                return _context4.abrupt("return", new promise(function (resolve) {
                  setTimeout(function () {
                    ...
                    if (!cameraInitializationFailure) {
                      var _this$abortedCameraIn;

                      (_this$abortedCameraIn = _this.abortedCameraInitializationResolveCallback) === null || _this$abortedCameraIn === void 0 ? void 0 : _this$abortedCameraIn.call(_this);
                    }
    ...
    value: function () {
      var _videoTrackMuteRecovery = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee16(event) {
        var isMuteEvent;
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                ...
                Logger.log(Logger.Level.DEBUG, "Detected video track \"".concat(event.type, "\" event, delay camera video stream access detection"));
                this.setCameraAccessTimeout();
                return _context16.abrupt("return");

              case 4:
                isMuteEvent = event.type === "mute";

                if (isMuteEvent !== this.gui.isCameraRecoveryVisible()) {
                  Logger.log(Logger.Level.DEBUG, "Detected video track \"".concat(event.type, "\" event, ").concat(isMuteEvent ? "enable" : "disable", " camera recovery"));
      ...
      function videoTrackMuteRecovery(_x10) {
    ...
    value: function () {
      var _triggerManualFocusForContinuous = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee19() {
        ...
        var manualFocusResetNeeded, videoTracks, _videoTracks$0$getCon;
          ...
          while (1) {
            switch (_context19.prev = _context19.next) {
              ...
              case 2:
                ...
                manualFocusResetNeeded = true;
                videoTracks = this.mediaStream.getVideoTracks(); // istanbul ignore else

                if (videoTracks.length !== 0 && typeof videoTracks[0].getConstraints === "function") {
                  manualFocusResetNeeded = ((_videoTracks$0$getCon = videoTracks[0].getConstraints().advanced) === null || _videoTracks$0$getCon === void 0 ? void 0 : _videoTracks$0$getCon.some(function (constraint) {
              ...
              case 12:
                _context19.next = 14;
                return this.triggerFocusMode(MeteringMode.MANUAL);
    ...
    value: function () {
        ...
        return regenerator.wrap(function _callee21$(_context21) {
          while (1) {
            switch (_context21.prev = _context21.next) {
              ...
              case 17:
                if (!focusModeCapability.includes(MeteringMode.SINGLE_SHOT)) {
                  _context21.next = 20;
                  break;
                }
      ...
      function triggerManualFocus(_x11) {
    ...
    value: function () {
      ...
      function triggerFocusMode(_x13) {
    ...
    value: function () {
      ...
      function initializeCameraAndCheckUpdatedSettings(_x14) {
    ...
    value: function () {
      ...
      function handleCameraInitializationError(_x15, _x16, _x17) {
    ...
    value: function () {
      var _initializeCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee27(camera, cameraResolutionConstraint) {
          ...
          while (1) {
            switch (_context27.prev = _context27.next) {
              ...
              case 11:
                ...
                Logger.log(Logger.Level.DEBUG, "Camera accessed, waiting for camera video stream start..."); // Detect weird browser behaviour that on unsupported resolution returns a 2x2 video instead
              ...
              case 22:
                ...
                this.mediaStream.getVideoTracks().forEach(function (track) {
                  ...
                  track.addEventListener("ended", _this8.videoTrackEndedListener); // If the track gets muted we need to give the chance to manually reinitialize the camera to access it again
                  ...
                  track.addEventListener("unmute", _this8.videoTrackMuteListener);
                });
                _context27.prev = 24;
                _context27.next = 27;
        ...
        }, _callee27, this, [[8, 38], [24, 29]]);
      }));

      function initializeCamera(_x18, _x19) {
    ...
    value: function setCameraAccessTimeout() {
      var _this9 = this;

      window.clearTimeout(this.cameraAccessTimeout);
      this.cameraAccessTimeout = window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee28() {
        var _this9$cameraAccessRe;
    ...
    value: function checkCameraAccess(camera) {
      var _this10 = this;

      return new promise(function (_, reject) {
        _this10.cameraAccessRejectCallback = function (reason) {
          Logger.log(Logger.Level.DEBUG, "Camera video stream access failure (video data load timeout):", camera);

          _this10.gui.setCameraRecoveryVisible(true);

          reject(reason);
        };

        _this10.setCameraAccessTimeout();
      });
    }
  }, {
    key: "checkVideoMetadata",
    value: function () {
      var _checkVideoMetadata = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee30(camera) {
        var _this11 = this;
            ...
            switch (_context30.prev = _context30.next) {
              case 0:
                return _context30.abrupt("return", new promise(function (resolve, reject) {
                  _this11.gui.videoElement.onloadeddata = function () {
                    _this11.gui.videoElement.onloadeddata = null;
                    ...
                    if (_this11.gui.videoElement.videoWidth > 2 && _this11.gui.videoElement.videoHeight > 2 && _this11.gui.videoElement.currentTime > 0) {
                      _this11.updateActiveCameraCurrentResolution(camera);
                    ...
                    window.clearInterval(_this11.videoMetadataCheckInterval);
                    _this11.videoMetadataCheckInterval = window.setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee29() {
                        ...
                        while (1) {
                          switch (_context29.prev = _context29.next) {
                            case 0:
                              ...
                              window.clearInterval(_this11.videoMetadataCheckInterval);
                              _context29.next = 6;
                              return _this11.stopStream(true);

                            case 6:
                              return _context29.abrupt("return", reject(new CustomError(CameraManager.notReadableErrorParameters)));
    ...
    value: function setupCameraStreamVideo(camera, stream) {
      ...
      var cameraStreamVideoCheck = promise.race([this.checkCameraAccess(camera), this.checkVideoMetadata(camera), // tslint:disable-next-line: promise-must-complete
      new promise(function (resolve) {
        _this12.abortedCameraInitializationResolveCallback = resolve;
      })]);
...
var GUI = /*#__PURE__*/function () {
  ...
  function GUI(options) {
    ...
    _defineProperty(this, "cameraRecoveryElement", void 0);
    ...
    _defineProperty(this, "webGLContextLostListener", void 0);
  ...
  _createClass(GUI, [{
    ...
    value: function destroy() {
      var _this$contextWebGL, _this$contextWebGL$ca, _this$contextWebGL2, _this$contextWebGL2$g;
      ...
      (_this$contextWebGL = this.contextWebGL) === null || _this$contextWebGL === void 0 ? void 0 : (_this$contextWebGL$ca = _this$contextWebGL.canvas) === null || _this$contextWebGL$ca === void 0 ? void 0 : _this$contextWebGL$ca.removeEventListener("webglcontextlost", this.webGLContextLostListener);
      (_this$contextWebGL2 = this.contextWebGL) === null || _this$contextWebGL2 === void 0 ? void 0 : (_this$contextWebGL2$g = _this$contextWebGL2.getExtension("WEBGL_lose_context")) === null || _this$contextWebGL2$g === void 0 ? void 0 : _this$contextWebGL2$g.loseContext();
    ...
    value: function setupCameraUploadGuiAssets() {
      ...
      var cameraUploadInputCheckFunction = function cameraUploadInputCheckFunction(event) {
        // istanbul ignore next
        if (_this2.scanningPaused || _this2.cameraUploadInProgress) {
          event.preventDefault();
        }
      };
      ...
      [this.cameraUploadProgressElement.style, cameraUploadButtonIconElement.style].forEach(function (style) {
        assign(style, defaultSettings.buttonStyle, _this2.singleImageModeSettings.buttonStyle);
      });
    ...
    value: function () {
      var _checkAndRecoverPlayback = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        ...
        var srcObject, _srcObject$getVideoTr;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(!srcObject.active || ((_srcObject$getVideoTr = srcObject.getVideoTracks()[0]) === null || _srcObject$getVideoTr === void 0 ? void 0 : _srcObject$getVideoTr.muted) !== false)) {
                  _context.next = 13;
                  break;
                }
    ...
    value: function cameraUploadFile() {
      ...
      if (files != null && files.length !== 0) {
        ...
        fileReader.onload = function () {
          _this3.cameraUploadInputElement.value = ""; // istanbul ignore else

          if (fileReader.result != null) {
            image.onload = _this3.cameraUploadImageLoad.bind(_this3, image); // istanbul ignore next
            ...
            image.onerror = function () {
              _this3.cameraUploadInProgress = false;
    ...
    value: function () {
      var _cameraRecoveryListener = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(event) {
        var _this$cameraManager5;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 5;
                return (_this$cameraManager5 = this.cameraManager) === null || _this$cameraManager5 === void 0 ? void 0 : _this$cameraManager5.reinitializeCamera();
      ...
      function cameraRecoveryListener(_x6) {
        return _cameraRecoveryListener.apply(this, arguments);
      }

      return cameraRecoveryListener;
    }()
  }, {
    ...
    value: function setupCameraSwitcher() {
      ...
      ["touchstart", "mousedown"].forEach(function (eventName) {
        _this4.cameraSwitcherElement.addEventListener(eventName, _this4.cameraSwitcherListener.bind(_this4));
      });
    }
  }, {
    key: "setupCameraRecovery",
    value: function setupCameraRecovery(cameraRecoveryText) {
      var _this5 = this;
      ...
      ["touchstart", "mousedown"].forEach(function (eventName) {
        _this5.cameraRecoveryElement.addEventListener(eventName, _this5.cameraRecoveryListener.bind(_this5));
      });
    }
  }, {
    ...
    value: function setupTorchToggler() {
      ...
      ["touchstart", "mousedown"].forEach(function (eventName) {
        _this6.torchTogglerElement.addEventListener(eventName, /*#__PURE__*/function () {
          var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(event) {
            return regenerator.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
...
_defineProperty(GUI, "cameraRecoveryElementClassName", "scandit-camera-recovery");
...
var BarcodePicker = /*#__PURE__*/function () {
  function BarcodePicker(originElement, _ref) {
    ...
    var visible = _ref.visible,
        ...
        cameraRecoveryText = _ref.cameraRecoveryText,
...
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (getOwnPropertySymbols) { var symbols = getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : getOwnPropertyDescriptors ? Object.defineProperties(target, getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              Logger.log(Logger.Level.INFO, "Scandit Web SDK version: 5.12.1");
