	    ...
	    if (exports.BrowserHelper.isDesktopDevice()) {
	      ...
	      if (allHaveBlankLabel) {
	        ...
	        if (cameraOfType.length === 1) {
	          ...
	          mainCameraForType = cameraOfType[cameraType === exports.Camera.Type.FRONT ? 0 : cameraOfType.length - 1];
	        }
	      } else {
	        mainCameraForType = cameras.filter(function (camera) {
	          return camera.cameraType === cameraType;
	            ...
	            switch (_context16.prev = _context16.next) {
	              ...
	              case 4:
	                ...
	                if (isMuteEvent !== this.gui.isCameraRecoveryVisible()) {
	                  exports.Logger.log(exports.Logger.Level.DEBUG, "Detected video track \"".concat(event.type, "\" event, ").concat(isMuteEvent ? "enable" : "disable", " camera recovery"));
	    ...
	    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
	      ...
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              exports.Logger.log(exports.Logger.Level.INFO, "Scandit Web SDK version: 5.12.1");
